...
import { allTasks } from "../services/TaskService"
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        ...
        const data = await allTasks() // from service
          ...
          <tbody id="projects-table-body">
            {tasks.map((task) => (
              <tr key={task.id}>
                ...
                <td>
                  <small className="text-muted">{task.start_date}</small>
                </td>
                <td>
                  <small className="text-muted">{task.end_date}</small>
                </td>
                <td>
